export const FOOTER_LINKS = [
  ...
  { path: '/stories', label: 'Project Stories' },
  ...
  values: [
    {
      ...
      desc: 'Every frame is built and every weave is done by skilled artisans in our Nyeri and Nairobi ateliers.',
      image: '/images/projects/project-craftsmanship-weaving.jpg',
    },
    {
      title: 'Custom by Design',
      desc: 'No catalogue limits — we tailor sizes, colours, and weave patterns to your space and vision.',
      image: '/images/projects/project-original-modular-grey-white.jpg',
    },
    {
      title: 'Built to Last',
      desc: 'Premium synthetic rattan selected for Kenyan climates — resistant to sun, rain, and daily use.',
      image: '/images/projects/project-original-living-set-wide.jpg',
    },
  ],
  founder: {
...
export const MATERIALS = [
  ...
  },
  {
    ...
    desc: 'High-density foam cushions with premium fabric covers — coordinated to complement your chosen weave palette.',
    care: 'Remove covers for gentle machine wash where applicable. Keep cushions dry when used outdoors.',
    image: '/images/projects/project-original-armchair-shaggy.jpg',
  },
  {
    title: 'Glass & Accent Finishes',
    desc: 'Tempered glass tops, gold-accent legs, and checkered weave details on cabinets and tables — luxury finishes built to order.',
    care: 'Clean glass with standard glass cleaner. Polish metal accents with a soft dry cloth.',
    image: '/images/projects/project-original-cabinet-gold.jpg',
  },
]
...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'Yes — we deliver finished furniture across Kenya. Delivery costs depend on location and piece size. We will include this in your quote.',
  },
  {
    q: 'What weave patterns and colours are available?',
    a: 'We offer black-and-white checkered, warm brown weaves, geometric chevrons, and solid colour combinations. Bring your inspiration — we can match most references.',
  },
  {
...
export const DELIVERY_INFO = {
  steps: [
    { title: 'Order Confirmation', desc: 'Once your design and quote are approved, we schedule your build in the Nyeri production atelier.' },
    { title: 'Workshop Build', desc: 'Your piece is hand-woven and quality-checked before leaving our workshop.' },
