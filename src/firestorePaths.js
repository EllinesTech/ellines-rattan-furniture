/**
 * Ellines Rattan Furniture shares Firebase project `ellines-haven-web`
 * with Ellines Haven. Paths below are namespaced so we never collide with
 * Haven docs/collections (especially site_data/admin_credentials and users).
 */
export const FS = {
  SITE_DATA: 'site_data',
